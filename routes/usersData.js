...
const sql = 'select user.*,footstep.footstep, footstep.distance, footstep.calorie from user inner join footstep on user.userEmail=footstep.userEmail where footstep.userEmail=?';
